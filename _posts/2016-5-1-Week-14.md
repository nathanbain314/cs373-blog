...
###Challenges###
Forcing myself to read the refactoring book and study has been and will continue to be hard for me. If there is not a set amount of work that I have to due by a due date to turn in I have to actually force myself to complete the tasks, which is more difficult for me to do. 
